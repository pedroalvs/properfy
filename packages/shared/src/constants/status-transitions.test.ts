...
describe('VALID_TRANSITIONS', () => {
  ...
  it('REJECTED can transition to DRAFT, AWAITING_INSPECTOR or CANCELLED (cycle 5: groupable + cycle 6: TZ-aware + direct cancel)', () => {
    expect(VALID_TRANSITIONS.REJECTED).toEqual(['DRAFT', 'AWAITING_INSPECTOR', 'CANCELLED']);
  });
});
