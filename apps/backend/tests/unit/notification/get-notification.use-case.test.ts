...
import { NotificationForbiddenError, NotificationNotFoundError } from '../../../src/modules/notification/domain/notification.errors';
...
function makeSut() {
  ...
  const useCase = new GetNotificationUseCase(notificationRepo);
