...
export interface IFinancialEntryRepository {
  findById(id: string): Promise<FinancialEntryEntity | null>;
  ...
  updateStatus(id: string, status: FinancialEntryStatus, approvedByUserId?: string, approvedAt?: Date): Promise<void>;
