...
const IDS = {
  ...
  suburbPyrmont: stableSeedUuid('suburb-pyrmont'),
  suburbNewtown: stableSeedUuid('suburb-newtown'),
  suburbMarrickville: stableSeedUuid('suburb-marrickville'),
  suburbBondi: stableSeedUuid('suburb-bondi'),
  suburbManly: stableSeedUuid('suburb-manly'),
  suburbParramatta: stableSeedUuid('suburb-parramatta'),
  suburbDarlinghurst: stableSeedUuid('suburb-darlinghurst'),
  suburbRedfern: stableSeedUuid('suburb-redfern'),
  suburbPaddingtonNSW: stableSeedUuid('suburb-paddington-nsw'),
  suburbMosman: stableSeedUuid('suburb-mosman'),
  suburbBalmain: stableSeedUuid('suburb-balmain'),
  suburbLeichhardt: stableSeedUuid('suburb-leichhardt'),
  suburbRandwick: stableSeedUuid('suburb-randwick'),
  suburbMaroubra: stableSeedUuid('suburb-maroubra'),
  suburbBankstown: stableSeedUuid('suburb-bankstown'),
  suburbLiverpool: stableSeedUuid('suburb-liverpool'),
  suburbPenrith: stableSeedUuid('suburb-penrith'),
  suburbBlacktown: stableSeedUuid('suburb-blacktown'),
  // Suburbs — Melbourne (VIC)
  ...
  suburbSouthYarra: stableSeedUuid('suburb-south-yarra'),
  suburbStKilda: stableSeedUuid('suburb-st-kilda'),
  suburbFitzroy: stableSeedUuid('suburb-fitzroy'),
  suburbCarlton: stableSeedUuid('suburb-carlton'),
  suburbBrunswick: stableSeedUuid('suburb-brunswick'),
  suburbPrahran: stableSeedUuid('suburb-prahran'),
  suburbCollingwood: stableSeedUuid('suburb-collingwood'),
  suburbHawthorn: stableSeedUuid('suburb-hawthorn'),
  suburbToorak: stableSeedUuid('suburb-toorak'),
  suburbFootscray: stableSeedUuid('suburb-footscray'),
  suburbDocklands: stableSeedUuid('suburb-docklands'),
  suburbPortMelbourne: stableSeedUuid('suburb-port-melbourne'),
  suburbAlbertPark: stableSeedUuid('suburb-albert-park'),
  suburbWilliamstown: stableSeedUuid('suburb-williamstown'),
  suburbBoxHill: stableSeedUuid('suburb-box-hill'),
  suburbClayton: stableSeedUuid('suburb-clayton'),
  suburbDandenong: stableSeedUuid('suburb-dandenong'),
  // Suburbs — Brisbane (QLD)
  suburbBrisbaneCity: stableSeedUuid('suburb-brisbane-city'),
  suburbFortitudeValley: stableSeedUuid('suburb-fortitude-valley'),
  suburbSouthBrisbane: stableSeedUuid('suburb-south-brisbane'),
  suburbWestEnd: stableSeedUuid('suburb-west-end'),
  suburbNewFarm: stableSeedUuid('suburb-new-farm'),
  suburbKangarooPoint: stableSeedUuid('suburb-kangaroo-point'),
  suburbWoolloongabba: stableSeedUuid('suburb-woolloongabba'),
  suburbSpringHill: stableSeedUuid('suburb-spring-hill'),
  suburbMilton: stableSeedUuid('suburb-milton'),
  suburbPaddingtonQLD: stableSeedUuid('suburb-paddington-qld'),
  suburbToowong: stableSeedUuid('suburb-toowong'),
  suburbIndooroopilly: stableSeedUuid('suburb-indooroopilly'),
  suburbChermside: stableSeedUuid('suburb-chermside'),
  suburbCarindale: stableSeedUuid('suburb-carindale'),
  suburbMountGravatt: stableSeedUuid('suburb-mount-gravatt'),
  // Suburbs — Perth (WA)
  suburbPerth: stableSeedUuid('suburb-perth'),
  suburbFremantle: stableSeedUuid('suburb-fremantle'),
  suburbSubiaco: stableSeedUuid('suburb-subiaco'),
  suburbLeederville: stableSeedUuid('suburb-leederville'),
  suburbNorthbridge: stableSeedUuid('suburb-northbridge'),
  suburbMountLawley: stableSeedUuid('suburb-mount-lawley'),
  suburbVictoriaPark: stableSeedUuid('suburb-victoria-park'),
  suburbSouthPerth: stableSeedUuid('suburb-south-perth'),
  suburbClaremont: stableSeedUuid('suburb-claremont'),
  suburbCottesloe: stableSeedUuid('suburb-cottesloe'),
  // Suburbs — Adelaide (SA)
  suburbAdelaide: stableSeedUuid('suburb-adelaide'),
  suburbNorthAdelaide: stableSeedUuid('suburb-north-adelaide'),
  suburbGlenelg: stableSeedUuid('suburb-glenelg'),
  suburbNorwood: stableSeedUuid('suburb-norwood'),
  suburbProspect: stableSeedUuid('suburb-prospect'),
  suburbUnley: stableSeedUuid('suburb-unley'),
  suburbGoodwood: stableSeedUuid('suburb-goodwood'),
  suburbHydePark: stableSeedUuid('suburb-hyde-park'),
  suburbWalkerville: stableSeedUuid('suburb-walkerville'),
  suburbHenleyBeach: stableSeedUuid('suburb-henley-beach'),
  // Suburbs — Sao Paulo (SP)
  suburbJardins: stableSeedUuid('suburb-jardins'),
  suburbVilaMariana: stableSeedUuid('suburb-vila-mariana'),
  suburbPinheiros: stableSeedUuid('suburb-pinheiros'),
  suburbMoema: stableSeedUuid('suburb-moema'),
  suburbItaimBibi: stableSeedUuid('suburb-itaim-bibi'),
  suburbVilaMadalena: stableSeedUuid('suburb-vila-madalena'),
  suburbPerdizes: stableSeedUuid('suburb-perdizes'),
  suburbConsolacao: stableSeedUuid('suburb-consolacao'),
  suburbBelaVistaSP: stableSeedUuid('suburb-bela-vista-sp'),
  suburbLiberdade: stableSeedUuid('suburb-liberdade'),
  suburbBrooklin: stableSeedUuid('suburb-brooklin'),
  suburbCampoBelo: stableSeedUuid('suburb-campo-belo'),
  suburbSantoAmaro: stableSeedUuid('suburb-santo-amaro'),
  suburbMorumbi: stableSeedUuid('suburb-morumbi'),
  suburbButanta: stableSeedUuid('suburb-butanta'),
  suburbLapa: stableSeedUuid('suburb-lapa'),
  suburbSantanaSP: stableSeedUuid('suburb-santana-sp'),
  suburbTatuape: stableSeedUuid('suburb-tatuape'),
  suburbVilaOlimpia: stableSeedUuid('suburb-vila-olimpia'),
  suburbHigienopolis: stableSeedUuid('suburb-higienopolis'),
  suburbParaiso: stableSeedUuid('suburb-paraiso'),
  suburbAclimacao: stableSeedUuid('suburb-aclimacao'),
  suburbCambuci: stableSeedUuid('suburb-cambuci'),
  suburbIpiranga: stableSeedUuid('suburb-ipiranga'),
  suburbSaude: stableSeedUuid('suburb-saude'),
  // Suburbs — Rio de Janeiro (RJ)
  suburbCopacabana: stableSeedUuid('suburb-copacabana'),
  suburbIpanema: stableSeedUuid('suburb-ipanema'),
  suburbLeblon: stableSeedUuid('suburb-leblon'),
  suburbBotafogo: stableSeedUuid('suburb-botafogo'),
  suburbFlamengo: stableSeedUuid('suburb-flamengo'),
  suburbLaranjeiras: stableSeedUuid('suburb-laranjeiras'),
  suburbTijuca: stableSeedUuid('suburb-tijuca'),
  suburbBarraDaTijuca: stableSeedUuid('suburb-barra-da-tijuca'),
  suburbRecreio: stableSeedUuid('suburb-recreio'),
  suburbGavea: stableSeedUuid('suburb-gavea'),
  suburbJardimBotanico: stableSeedUuid('suburb-jardim-botanico'),
  suburbLagoa: stableSeedUuid('suburb-lagoa'),
  suburbHumaita: stableSeedUuid('suburb-humaita'),
  suburbCatete: stableSeedUuid('suburb-catete'),
  suburbGloria: stableSeedUuid('suburb-gloria'),
  suburbCentroRJ: stableSeedUuid('suburb-centro-rj'),
  suburbLapaRJ: stableSeedUuid('suburb-lapa-rj'),
  suburbSantaTeresa: stableSeedUuid('suburb-santa-teresa'),
  suburbSaoConrado: stableSeedUuid('suburb-sao-conrado'),
  suburbUrca: stableSeedUuid('suburb-urca'),
  // Suburbs — Belo Horizonte (MG)
  suburbSavassi: stableSeedUuid('suburb-savassi'),
  suburbLourdes: stableSeedUuid('suburb-lourdes'),
  suburbFuncionarios: stableSeedUuid('suburb-funcionarios'),
  suburbSerra: stableSeedUuid('suburb-serra'),
  suburbSantoAgostinho: stableSeedUuid('suburb-santo-agostinho'),
  suburbSion: stableSeedUuid('suburb-sion'),
  suburbBuritis: stableSeedUuid('suburb-buritis'),
  suburbMangabeiras: stableSeedUuid('suburb-mangabeiras'),
  suburbSaoPedro: stableSeedUuid('suburb-sao-pedro'),
  suburbAnchieta: stableSeedUuid('suburb-anchieta'),
  // Suburbs — Curitiba (PR)
  suburbCentroCWB: stableSeedUuid('suburb-centro-cwb'),
  suburbBatel: stableSeedUuid('suburb-batel'),
  suburbAguaVerde: stableSeedUuid('suburb-agua-verde'),
  suburbBigorrilho: stableSeedUuid('suburb-bigorrilho'),
  suburbJuveve: stableSeedUuid('suburb-juveve'),
  suburbAltoDaGloria: stableSeedUuid('suburb-alto-da-gloria'),
  suburbCabral: stableSeedUuid('suburb-cabral'),
  suburbHugoLange: stableSeedUuid('suburb-hugo-lange'),
  suburbSaoFrancisco: stableSeedUuid('suburb-sao-francisco'),
  suburbMerces: stableSeedUuid('suburb-merces'),
  // Suburbs — Porto Alegre (RS)
  suburbMoinhosDeVento: stableSeedUuid('suburb-moinhos-de-vento'),
  suburbBelaVistaPOA: stableSeedUuid('suburb-bela-vista-poa'),
  suburbPetropolis: stableSeedUuid('suburb-petropolis'),
  suburbRioBranco: stableSeedUuid('suburb-rio-branco'),
  suburbMeninoDeus: stableSeedUuid('suburb-menino-deus'),
  suburbCidadeBaixa: stableSeedUuid('suburb-cidade-baixa'),
  suburbSantanaPOA: stableSeedUuid('suburb-santana-poa'),
  suburbFloresta: stableSeedUuid('suburb-floresta'),
  suburbIndependencia: stableSeedUuid('suburb-independencia'),
  suburbMontSerrat: stableSeedUuid('suburb-mont-serrat'),
  // Service regions — Australia
  regionSydneyCbd: stableSeedUuid('region-sydney-cbd'),
  regionSydneyInnerWest: stableSeedUuid('region-sydney-inner-west'),
  regionNorthShore: stableSeedUuid('region-north-shore'),
  regionSydneyEastern: stableSeedUuid('region-sydney-eastern'),
  regionSydneyWest: stableSeedUuid('region-sydney-west'),
  regionMelbourneInner: stableSeedUuid('region-melbourne-inner'),
  regionMelbourneInnerEast: stableSeedUuid('region-melbourne-inner-east'),
  regionMelbourneInnerNorth: stableSeedUuid('region-melbourne-inner-north'),
  regionBrisbaneInner: stableSeedUuid('region-brisbane-inner'),
  regionPerthMetro: stableSeedUuid('region-perth-metro'),
  regionAdelaideMetro: stableSeedUuid('region-adelaide-metro'),
  // Service regions — Brazil
  regionSPZonaSul: stableSeedUuid('region-sp-zona-sul'),
  regionSPCentroOeste: stableSeedUuid('region-sp-centro-oeste'),
  regionSPZonaOeste: stableSeedUuid('region-sp-zona-oeste'),
  regionRioZonaSul: stableSeedUuid('region-rio-zona-sul'),
  regionRioZonaOeste: stableSeedUuid('region-rio-zona-oeste'),
  regionBHCentroSul: stableSeedUuid('region-bh-centro-sul'),
  regionCuritibaCentro: stableSeedUuid('region-curitiba-centro'),
  regionPOACentro: stableSeedUuid('region-poa-centro'),
} as const;
...
async function main() {
  ...
  const suburbsData = [
    ...
    { id: IDS.suburbPyrmont, name: 'Pyrmont', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2009' },
    { id: IDS.suburbNewtown, name: 'Newtown', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2042' },
    { id: IDS.suburbMarrickville, name: 'Marrickville', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2204' },
    { id: IDS.suburbBondi, name: 'Bondi', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2026' },
    { id: IDS.suburbManly, name: 'Manly', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2095' },
    { id: IDS.suburbParramatta, name: 'Parramatta', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2150' },
    { id: IDS.suburbDarlinghurst, name: 'Darlinghurst', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2010' },
    { id: IDS.suburbRedfern, name: 'Redfern', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2016' },
    { id: IDS.suburbPaddingtonNSW, name: 'Paddington', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2021' },
    { id: IDS.suburbMosman, name: 'Mosman', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2088' },
    { id: IDS.suburbBalmain, name: 'Balmain', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2041' },
    { id: IDS.suburbLeichhardt, name: 'Leichhardt', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2040' },
    { id: IDS.suburbRandwick, name: 'Randwick', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2031' },
    { id: IDS.suburbMaroubra, name: 'Maroubra', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2035' },
    { id: IDS.suburbBankstown, name: 'Bankstown', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2200' },
    { id: IDS.suburbLiverpool, name: 'Liverpool', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2170' },
    { id: IDS.suburbPenrith, name: 'Penrith', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2750' },
    { id: IDS.suburbBlacktown, name: 'Blacktown', city: 'Sydney', state: 'NSW', country: 'AU', postcode: '2148' },
    ...
    { id: IDS.suburbSouthYarra, name: 'South Yarra', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3141' },
    { id: IDS.suburbStKilda, name: 'St Kilda', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3182' },
    { id: IDS.suburbFitzroy, name: 'Fitzroy', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3065' },
    { id: IDS.suburbCarlton, name: 'Carlton', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3053' },
    { id: IDS.suburbBrunswick, name: 'Brunswick', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3056' },
    { id: IDS.suburbPrahran, name: 'Prahran', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3181' },
    { id: IDS.suburbCollingwood, name: 'Collingwood', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3066' },
    { id: IDS.suburbHawthorn, name: 'Hawthorn', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3122' },
    { id: IDS.suburbToorak, name: 'Toorak', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3142' },
    { id: IDS.suburbFootscray, name: 'Footscray', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3011' },
    { id: IDS.suburbDocklands, name: 'Docklands', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3008' },
    { id: IDS.suburbPortMelbourne, name: 'Port Melbourne', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3207' },
    { id: IDS.suburbAlbertPark, name: 'Albert Park', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3206' },
    { id: IDS.suburbWilliamstown, name: 'Williamstown', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3016' },
    { id: IDS.suburbBoxHill, name: 'Box Hill', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3128' },
    { id: IDS.suburbClayton, name: 'Clayton', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3168' },
    { id: IDS.suburbDandenong, name: 'Dandenong', city: 'Melbourne', state: 'VIC', country: 'AU', postcode: '3175' },
    // ── Brisbane (QLD) — 15 suburbs ──
    { id: IDS.suburbBrisbaneCity, name: 'Brisbane City', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4000' },
    { id: IDS.suburbFortitudeValley, name: 'Fortitude Valley', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4006' },
    { id: IDS.suburbSouthBrisbane, name: 'South Brisbane', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4101' },
    { id: IDS.suburbWestEnd, name: 'West End', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4101' },
    { id: IDS.suburbNewFarm, name: 'New Farm', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4005' },
    { id: IDS.suburbKangarooPoint, name: 'Kangaroo Point', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4169' },
    { id: IDS.suburbWoolloongabba, name: 'Woolloongabba', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4102' },
    { id: IDS.suburbSpringHill, name: 'Spring Hill', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4000' },
    { id: IDS.suburbMilton, name: 'Milton', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4064' },
    { id: IDS.suburbPaddingtonQLD, name: 'Paddington', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4064' },
    { id: IDS.suburbToowong, name: 'Toowong', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4066' },
    { id: IDS.suburbIndooroopilly, name: 'Indooroopilly', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4068' },
    { id: IDS.suburbChermside, name: 'Chermside', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4032' },
    { id: IDS.suburbCarindale, name: 'Carindale', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4152' },
    { id: IDS.suburbMountGravatt, name: 'Mount Gravatt', city: 'Brisbane', state: 'QLD', country: 'AU', postcode: '4122' },
    // ── Perth (WA) — 10 suburbs ──
    { id: IDS.suburbPerth, name: 'Perth', city: 'Perth', state: 'WA', country: 'AU', postcode: '6000' },
    { id: IDS.suburbFremantle, name: 'Fremantle', city: 'Perth', state: 'WA', country: 'AU', postcode: '6160' },
    { id: IDS.suburbSubiaco, name: 'Subiaco', city: 'Perth', state: 'WA', country: 'AU', postcode: '6008' },
    { id: IDS.suburbLeederville, name: 'Leederville', city: 'Perth', state: 'WA', country: 'AU', postcode: '6007' },
    { id: IDS.suburbNorthbridge, name: 'Northbridge', city: 'Perth', state: 'WA', country: 'AU', postcode: '6003' },
    { id: IDS.suburbMountLawley, name: 'Mount Lawley', city: 'Perth', state: 'WA', country: 'AU', postcode: '6050' },
    { id: IDS.suburbVictoriaPark, name: 'Victoria Park', city: 'Perth', state: 'WA', country: 'AU', postcode: '6100' },
    { id: IDS.suburbSouthPerth, name: 'South Perth', city: 'Perth', state: 'WA', country: 'AU', postcode: '6151' },
    { id: IDS.suburbClaremont, name: 'Claremont', city: 'Perth', state: 'WA', country: 'AU', postcode: '6010' },
    { id: IDS.suburbCottesloe, name: 'Cottesloe', city: 'Perth', state: 'WA', country: 'AU', postcode: '6011' },
    // ── Adelaide (SA) — 10 suburbs ──
    { id: IDS.suburbAdelaide, name: 'Adelaide', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5000' },
    { id: IDS.suburbNorthAdelaide, name: 'North Adelaide', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5006' },
    { id: IDS.suburbGlenelg, name: 'Glenelg', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5045' },
    { id: IDS.suburbNorwood, name: 'Norwood', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5067' },
    { id: IDS.suburbProspect, name: 'Prospect', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5082' },
    { id: IDS.suburbUnley, name: 'Unley', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5061' },
    { id: IDS.suburbGoodwood, name: 'Goodwood', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5034' },
    { id: IDS.suburbHydePark, name: 'Hyde Park', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5061' },
    { id: IDS.suburbWalkerville, name: 'Walkerville', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5081' },
    { id: IDS.suburbHenleyBeach, name: 'Henley Beach', city: 'Adelaide', state: 'SA', country: 'AU', postcode: '5022' },
    // ── Sao Paulo (SP) — 25 bairros ──
    { id: IDS.suburbJardins, name: 'Jardins', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbVilaMariana, name: 'Vila Mariana', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbPinheiros, name: 'Pinheiros', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbMoema, name: 'Moema', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbItaimBibi, name: 'Itaim Bibi', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbVilaMadalena, name: 'Vila Madalena', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbPerdizes, name: 'Perdizes', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbConsolacao, name: 'Consolacao', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbBelaVistaSP, name: 'Bela Vista', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbLiberdade, name: 'Liberdade', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbBrooklin, name: 'Brooklin', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbCampoBelo, name: 'Campo Belo', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbSantoAmaro, name: 'Santo Amaro', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbMorumbi, name: 'Morumbi', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbButanta, name: 'Butanta', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbLapa, name: 'Lapa', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbSantanaSP, name: 'Santana', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbTatuape, name: 'Tatuape', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbVilaOlimpia, name: 'Vila Olimpia', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbHigienopolis, name: 'Higienopolis', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbParaiso, name: 'Paraiso', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbAclimacao, name: 'Aclimacao', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbCambuci, name: 'Cambuci', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbIpiranga, name: 'Ipiranga', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    { id: IDS.suburbSaude, name: 'Saude', city: 'Sao Paulo', state: 'SP', country: 'BR', postcode: null },
    // ── Rio de Janeiro (RJ) — 20 bairros ──
    { id: IDS.suburbCopacabana, name: 'Copacabana', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbIpanema, name: 'Ipanema', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbLeblon, name: 'Leblon', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbBotafogo, name: 'Botafogo', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbFlamengo, name: 'Flamengo', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbLaranjeiras, name: 'Laranjeiras', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbTijuca, name: 'Tijuca', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbBarraDaTijuca, name: 'Barra da Tijuca', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbRecreio, name: 'Recreio', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbGavea, name: 'Gavea', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbJardimBotanico, name: 'Jardim Botanico', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbLagoa, name: 'Lagoa', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbHumaita, name: 'Humaita', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbCatete, name: 'Catete', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbGloria, name: 'Gloria', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbCentroRJ, name: 'Centro', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbLapaRJ, name: 'Lapa', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbSantaTeresa, name: 'Santa Teresa', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbSaoConrado, name: 'Sao Conrado', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    { id: IDS.suburbUrca, name: 'Urca', city: 'Rio de Janeiro', state: 'RJ', country: 'BR', postcode: null },
    // ── Belo Horizonte (MG) — 10 bairros ──
    { id: IDS.suburbSavassi, name: 'Savassi', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbLourdes, name: 'Lourdes', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbFuncionarios, name: 'Funcionarios', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbSerra, name: 'Serra', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbSantoAgostinho, name: 'Santo Agostinho', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbSion, name: 'Sion', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbBuritis, name: 'Buritis', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbMangabeiras, name: 'Mangabeiras', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbSaoPedro, name: 'Sao Pedro', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    { id: IDS.suburbAnchieta, name: 'Anchieta', city: 'Belo Horizonte', state: 'MG', country: 'BR', postcode: null },
    // ── Curitiba (PR) — 10 bairros ──
    { id: IDS.suburbCentroCWB, name: 'Centro', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbBatel, name: 'Batel', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbAguaVerde, name: 'Agua Verde', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbBigorrilho, name: 'Bigorrilho', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbJuveve, name: 'Juveve', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbAltoDaGloria, name: 'Alto da Gloria', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbCabral, name: 'Cabral', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbHugoLange, name: 'Hugo Lange', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbSaoFrancisco, name: 'Sao Francisco', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    { id: IDS.suburbMerces, name: 'Merces', city: 'Curitiba', state: 'PR', country: 'BR', postcode: null },
    // ── Porto Alegre (RS) — 10 bairros ──
    { id: IDS.suburbMoinhosDeVento, name: 'Moinhos de Vento', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbBelaVistaPOA, name: 'Bela Vista', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbPetropolis, name: 'Petropolis', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbRioBranco, name: 'Rio Branco', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbMeninoDeus, name: 'Menino Deus', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbCidadeBaixa, name: 'Cidade Baixa', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbSantanaPOA, name: 'Santana', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbFloresta, name: 'Floresta', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbIndependencia, name: 'Independencia', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
    { id: IDS.suburbMontSerrat, name: 'Mont Serrat', city: 'Porto Alegre', state: 'RS', country: 'BR', postcode: null },
  ];
  ...
  const regions = [
    // Australia
    {
      id: IDS.regionSydneyCbd, name: 'Sydney CBD & Inner East', state: 'NSW', country: 'AU',
      suburbIds: [IDS.suburbSydney, IDS.suburbSurryHills, IDS.suburbDarlinghurst, IDS.suburbPaddingtonNSW, IDS.suburbRedfern],
    },
    {
      id: IDS.regionSydneyInnerWest, name: 'Sydney Inner West', state: 'NSW', country: 'AU',
      suburbIds: [IDS.suburbNewtown, IDS.suburbMarrickville, IDS.suburbBalmain, IDS.suburbLeichhardt, IDS.suburbGlebe],
    },
    {
      id: IDS.regionNorthShore, name: 'Sydney North Shore', state: 'NSW', country: 'AU',
      suburbIds: [IDS.suburbNorthSydney, IDS.suburbCrowsNest, IDS.suburbChatswood, IDS.suburbMosman],
    },
    {
      id: IDS.regionSydneyEastern, name: 'Sydney Eastern Suburbs', state: 'NSW', country: 'AU',
      suburbIds: [IDS.suburbBondi, IDS.suburbRandwick, IDS.suburbMaroubra],
    },
    {
      id: IDS.regionSydneyWest, name: 'Sydney West', state: 'NSW', country: 'AU',
      suburbIds: [IDS.suburbParramatta, IDS.suburbBankstown, IDS.suburbLiverpool, IDS.suburbPenrith, IDS.suburbBlacktown],
    },
    {
      id: IDS.regionMelbourneInner, name: 'Melbourne Inner', state: 'VIC', country: 'AU',
      suburbIds: [IDS.suburbMelbourne, IDS.suburbSouthbank, IDS.suburbDocklands, IDS.suburbPortMelbourne],
    },
    {
      id: IDS.regionMelbourneInnerEast, name: 'Melbourne Inner East', state: 'VIC', country: 'AU',
      suburbIds: [IDS.suburbRichmond, IDS.suburbSouthYarra, IDS.suburbPrahran, IDS.suburbToorak, IDS.suburbHawthorn],
    },
    {
      id: IDS.regionMelbourneInnerNorth, name: 'Melbourne Inner North', state: 'VIC', country: 'AU',
      suburbIds: [IDS.suburbFitzroy, IDS.suburbCarlton, IDS.suburbBrunswick, IDS.suburbCollingwood],
    },
    {
      id: IDS.regionBrisbaneInner, name: 'Brisbane Inner', state: 'QLD', country: 'AU',
      suburbIds: [IDS.suburbBrisbaneCity, IDS.suburbFortitudeValley, IDS.suburbSouthBrisbane, IDS.suburbWestEnd, IDS.suburbNewFarm],
    },
    {
      id: IDS.regionPerthMetro, name: 'Perth Metro', state: 'WA', country: 'AU',
      suburbIds: [IDS.suburbPerth, IDS.suburbFremantle, IDS.suburbSubiaco, IDS.suburbNorthbridge],
    },
    {
      id: IDS.regionAdelaideMetro, name: 'Adelaide Metro', state: 'SA', country: 'AU',
      suburbIds: [IDS.suburbAdelaide, IDS.suburbNorthAdelaide, IDS.suburbGlenelg, IDS.suburbNorwood],
    },
    // Brazil
    {
      id: IDS.regionSPZonaSul, name: 'Sao Paulo Zona Sul', state: 'SP', country: 'BR',
      suburbIds: [IDS.suburbMoema, IDS.suburbVilaMariana, IDS.suburbCampoBelo, IDS.suburbSantoAmaro, IDS.suburbSaude, IDS.suburbIpiranga],
    },
    {
      id: IDS.regionSPCentroOeste, name: 'Sao Paulo Centro-Oeste', state: 'SP', country: 'BR',
      suburbIds: [IDS.suburbJardins, IDS.suburbPinheiros, IDS.suburbVilaMadalena, IDS.suburbPerdizes, IDS.suburbConsolacao, IDS.suburbHigienopolis],
    },
    {
      id: IDS.regionSPZonaOeste, name: 'Sao Paulo Zona Oeste', state: 'SP', country: 'BR',
      suburbIds: [IDS.suburbButanta, IDS.suburbLapa, IDS.suburbMorumbi],
    },
    {
      id: IDS.regionRioZonaSul, name: 'Rio Zona Sul', state: 'RJ', country: 'BR',
      suburbIds: [IDS.suburbCopacabana, IDS.suburbIpanema, IDS.suburbLeblon, IDS.suburbBotafogo, IDS.suburbFlamengo, IDS.suburbLaranjeiras, IDS.suburbHumaita, IDS.suburbUrca],
    },
    {
      id: IDS.regionRioZonaOeste, name: 'Rio Zona Oeste', state: 'RJ', country: 'BR',
      suburbIds: [IDS.suburbBarraDaTijuca, IDS.suburbRecreio, IDS.suburbSaoConrado],
    },
    {
      id: IDS.regionBHCentroSul, name: 'BH Centro-Sul', state: 'MG', country: 'BR',
      suburbIds: [IDS.suburbSavassi, IDS.suburbLourdes, IDS.suburbFuncionarios, IDS.suburbSerra, IDS.suburbSantoAgostinho],
    },
    {
      id: IDS.regionCuritibaCentro, name: 'Curitiba Centro', state: 'PR', country: 'BR',
      suburbIds: [IDS.suburbCentroCWB, IDS.suburbBatel, IDS.suburbAguaVerde, IDS.suburbBigorrilho],
    },
    {
      id: IDS.regionPOACentro, name: 'Porto Alegre Centro', state: 'RS', country: 'BR',
      suburbIds: [IDS.suburbMoinhosDeVento, IDS.suburbBelaVistaPOA, IDS.suburbPetropolis, IDS.suburbRioBranco],
    },
  ];
  ...
  const inspectorRegions = [
    // Mike Inspector: Sydney CBD & Inner East + Sydney Inner West + Sydney North Shore
    { inspector_id: IDS.inspectorLinked, region_id: IDS.regionSydneyCbd },
    { inspector_id: IDS.inspectorLinked, region_id: IDS.regionSydneyInnerWest },
    { inspector_id: IDS.inspectorLinked, region_id: IDS.regionNorthShore },
    // Carlos Mendez: Sydney Eastern Suburbs + Sydney CBD & Inner East
    { inspector_id: IDS.inspectorIndep, region_id: IDS.regionSydneyEastern },
    { inspector_id: IDS.inspectorIndep, region_id: IDS.regionSydneyCbd },
    // Lisa Wong: Melbourne Inner + Melbourne Inner East + Melbourne Inner North
    { inspector_id: IDS.inspectorLinked2, region_id: IDS.regionMelbourneInner },
    { inspector_id: IDS.inspectorLinked2, region_id: IDS.regionMelbourneInnerEast },
    { inspector_id: IDS.inspectorLinked2, region_id: IDS.regionMelbourneInnerNorth },
  ];
