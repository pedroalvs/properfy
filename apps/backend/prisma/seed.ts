...
async function main() {
  ...
  await prisma.report.upsert({
    ...
    create: {
      ...
      filters_json: { tenantId: IDS.tenant, fromDate: '2026-03-01', toDate: '2026-03-31', dateAxis: 'SCHEDULED' },
      status: 'READY',
  ...
  await prisma.report.upsert({
    ...
    create: {
      ...
      filters_json: { tenantId: IDS.tenant, fromDate: '2026-03-01', toDate: '2026-03-31' },
      status: 'PENDING',
      requested_by_user_id: IDS.userAM,
    },
  });
  ...
  await prisma.report.upsert({
    ...
    create: {
      ...
      filters_json: { fromDate: '2026-01-01', toDate: '2026-03-31', dateAxis: 'SCHEDULED' },
      status: 'PROCESSING',
      requested_by_user_id: IDS.userAM,
      started_at: new Date(),
    },
  ...
  await prisma.report.upsert({
    ...
    create: {
      ...
      filters_json: { tenantId: IDS.tenant2, fromDate: '2026-03-01', toDate: '2026-03-31', dateAxis: 'CREATED' },
      status: 'FAILED',
      requested_by_user_id: IDS.userAM,
