/*
  ...
  - Drop `rental_tenant_name`, `primary_email`, `secondary_email`, `primary_phone`,
...
SET
  "snapshot_name"  = COALESCE("snapshot_name", "rental_tenant_name"),
...
DROP COLUMN "rental_tenant_name",
