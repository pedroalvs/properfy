...
export function Snackbar() {
  ...
  return (
    <div className="fixed right-4 top-4 z-[100] flex flex-col gap-2" data-testid="snackbar-container">
      {messages.map((msg) => (
        <div
          key={msg.id}
          className={`flex max-w-sm items-start gap-3 rounded px-4 py-3 shadow-lg ${typeStyles[msg.type]}`}
          role="alert"
        >
