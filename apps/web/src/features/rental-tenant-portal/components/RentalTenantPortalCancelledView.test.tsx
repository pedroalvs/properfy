...
import { RentalTenantPortalCancelledView } from './RentalTenantPortalCancelledView';

describe('RentalTenantPortalCancelledView', () => {
  it('shows the cancelled title', () => {
    render(<RentalTenantPortalCancelledView />);
  ...
  it('shows agency phone when provided', () => {
    render(<RentalTenantPortalCancelledView agencyPhone="+61 3 9876 5432" />);
  ...
  it('renders phone as a clickable link', () => {
    render(<RentalTenantPortalCancelledView agencyPhone="+61399865432" />);
