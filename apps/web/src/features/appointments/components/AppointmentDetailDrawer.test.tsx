    ...
    if (id === 'done') {
      return {
        appointment: {
          ...
          timeSlotStart: '09:00', timeSlotEnd: '12:00', contactPhone: '11999', contactEmail: 'john@test.com',
          inspectorId: null, inspectorName: null, keyRequired: false,
          meetingLocation: null, keyLocation: null, cancellationReason: null,
          doneCheckedByUserId: null, isOverdue: false, hasRentalTenantNote: false, rentalTenantNote: null,
...
describe('AppointmentDetailDrawer', () => {
  ...
  it('hides edit button for non-editable appointment statuses', () => {
    const onEdit = vi.fn();
    renderDrawer({ appointmentId: 'done', open: true, onEdit });
    expect(screen.queryByLabelText('Edit')).not.toBeInTheDocument();
  });
