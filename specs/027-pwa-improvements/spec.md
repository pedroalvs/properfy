...
**Why this priority**: Acceptance is irreversible (capacity is decremented, the group becomes the inspector's commitment). Inspectors today either accept blind or reject offers they could have taken, because they cannot see the per-appointment breakdown. Reducing that friction is the single highest-leverage offers improvement.
